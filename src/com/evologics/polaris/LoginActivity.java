...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {			
			//Generate LoginJSON
			JSONObject jsonLogin = PolarisUtil.generateLoginJSON(mEmail, mPassword);
			
			String loginModuleUrl = "https://polaris-app.herokuapp.com/api/login";
			String responseBody = PolarisUtil.serverRequest(jsonLogin, RequestMethod.POST, loginModuleUrl);
